...
export const styles = StyleSheet.create({
  ...
  panel: { marginHorizontal: 4, paddingHorizontal: 20, paddingTop: 14, paddingBottom: 56, borderWidth: 1, borderColor: "rgba(65,83,111,0.48)", borderRadius: 10, backgroundColor: C.panel },
  sectionTitle: { color: C.orange, fontSize: 18, lineHeight: 23, fontWeight: "800", marginBottom: 8 },
  variant: { minHeight: 104, borderRadius: 14, borderWidth: 1, borderColor: C.border, backgroundColor: "rgba(5,15,29,0.92)", marginBottom: 8, paddingHorizontal: 12, paddingVertical: 7, flexDirection: "row", alignItems: "center", position: "relative", overflow: "visible" },
  ...
  markSmall: { width: 23, height: 23, borderRadius: 12 },
  ...
  subhead: { color: C.text, fontSize: 18, lineHeight: 23, fontWeight: "800", marginTop: 6, marginBottom: 7 },
  row: { flexDirection: "row", gap: 8, marginBottom: 8 },
  player: { flex: 1, minHeight: 56, borderRadius: 11, borderWidth: 1, borderColor: C.border, backgroundColor: C.card, paddingLeft: 11, paddingRight: 34, flexDirection: "row", alignItems: "center", position: "relative" },
  ...
  inlineContactButton: { flex: 1, minHeight: 56, borderRadius: 11, borderWidth: 1, borderColor: C.orange, backgroundColor: C.card, paddingHorizontal: 10, flexDirection: "row", alignItems: "center", justifyContent: "center" },
  ...
  difficulty: { flex: 1, minHeight: 66, borderRadius: 11, borderWidth: 1, borderColor: C.border, backgroundColor: C.card, paddingHorizontal: 10, paddingVertical: 6 },
  diffTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", minHeight: 18 },
  stars: { fontSize: 18, letterSpacing: 0.4 },
  diffTitle: { color: C.text, fontSize: 15, lineHeight: 20, fontWeight: "800", marginTop: 1 },
  diffSubtitle: { color: C.muted, fontSize: 13, lineHeight: 18 },
  difficultyInfo: { borderWidth: 1, borderColor: "rgba(108,126,153,0.56)", borderRadius: 13, paddingHorizontal: 14, paddingVertical: 10, marginTop: 0, marginBottom: 12, backgroundColor: "rgba(11,24,40,0.96)" },
  difficultyInfoTitle: { color: C.text, fontSize: 17, lineHeight: 22, fontWeight: "900", marginBottom: 2 },
  difficultyInfoText: { color: C.muted, fontSize: 15, lineHeight: 21, marginBottom: 6 },
  infoRow: { minHeight: 25, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  ...
  inviteSummary: { borderWidth: 1, borderColor: C.border, borderRadius: 10, padding: 10, marginBottom: 8, backgroundColor: C.card },
  ...
  button: { minHeight: 56, borderRadius: 12, backgroundColor: C.orange, alignItems: "center", justifyContent: "center", marginTop: 4, elevation: 6 },
