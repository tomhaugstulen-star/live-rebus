...
export const styles = StyleSheet.create({
  ...
  panel: { marginHorizontal: 4, paddingHorizontal: 20, paddingTop: 18, paddingBottom: 70, borderWidth: 1, borderColor: "rgba(65,83,111,0.48)", borderRadius: 10, backgroundColor: C.panel },
  ...
  subhead: { color: C.text, fontSize: 18, lineHeight: 23, fontWeight: "800", marginTop: 10, marginBottom: 8 },
  ...
  contactPrompt: { minHeight: 58, borderRadius: 12, borderWidth: 1, borderColor: "rgba(255,104,0,0.58)", backgroundColor: "rgba(12,26,43,0.92)", paddingHorizontal: 12, paddingVertical: 8, marginTop: -2, marginBottom: 10, flexDirection: "row", alignItems: "center" },
  contactPromptIconWrap: { width: 38, height: 38, borderRadius: 19, backgroundColor: "rgba(255,104,0,0.14)", alignItems: "center", justifyContent: "center", marginRight: 10 },
  contactPromptIcon: { color: C.orange, fontSize: 23, lineHeight: 25, fontWeight: "900" },
  contactPromptCopy: { flex: 1, minWidth: 0 },
  contactPromptTitle: { color: C.text, fontSize: 15, lineHeight: 20, fontWeight: "900" },
  contactPromptText: { color: C.muted, fontSize: 14, lineHeight: 19, fontWeight: "600" },
  difficulty: { flex: 1, minHeight: 68, borderRadius: 11, borderWidth: 1, borderColor: C.border, backgroundColor: C.card, paddingHorizontal: 10, paddingVertical: 7 },
  ...
  difficultyInfo: { borderWidth: 1, borderColor: "rgba(108,126,153,0.56)", borderRadius: 14, paddingHorizontal: 14, paddingVertical: 13, marginTop: 0, marginBottom: 18, backgroundColor: "rgba(11,24,40,0.96)" },
  difficultyInfoTitle: { color: C.text, fontSize: 17, lineHeight: 22, fontWeight: "900", marginBottom: 3 },
  difficultyInfoText: { color: C.muted, fontSize: 15, lineHeight: 21, marginBottom: 10 },
  infoGrid: { flexDirection: "row", gap: 8 },
  infoPill: { flex: 1, minHeight: 56, borderRadius: 11, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)", backgroundColor: "rgba(255,255,255,0.035)", paddingHorizontal: 10, paddingVertical: 8, justifyContent: "center" },
  infoLabel: { color: C.muted, fontSize: 13, lineHeight: 17, fontWeight: "800", marginBottom: 2 },
  infoValue: { color: C.text, fontSize: 14, lineHeight: 19, fontWeight: "900" },
