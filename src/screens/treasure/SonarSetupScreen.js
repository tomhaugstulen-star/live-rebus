...
const styles = StyleSheet.create({
  ...
  sonarWrap: { width: 216, height: 216, alignItems: "center", justifyContent: "center", marginBottom: 18, shadowColor: C.cyan, shadowOpacity: 0.34, shadowRadius: 24, shadowOffset: { width: 0, height: 0 } },
  radarGlow: { position: "absolute", width: 164, height: 164, borderRadius: 82, backgroundColor: "rgba(34,211,238,0.08)", shadowColor: C.cyan, shadowOpacity: 0.55, shadowRadius: 28, shadowOffset: { width: 0, height: 0 } },
  outerRing: { ...ring, width: 216, height: 216, borderRadius: 108, borderColor: "rgba(34,211,238,0.34)" },
  middleRing: { ...ring, width: 156, height: 156, borderRadius: 78, borderColor: "rgba(34,211,238,0.52)" },
  innerRing: { ...ring, width: 92, height: 92, borderRadius: 46, borderColor: "rgba(34,211,238,0.68)" },
  sweep: { position: "absolute", width: 216, height: 216, alignItems: "center", justifyContent: "flex-start" },
  beam: { width: 4, height: 108, borderRadius: 2, backgroundColor: C.cyan, opacity: 0.84, shadowColor: C.cyan, shadowOpacity: 0.95, shadowRadius: 14, shadowOffset: { width: 0, height: 0 } },
  ...
  playerPrompt: { color: C.text, fontSize: 22, lineHeight: 28, fontWeight: "900", textAlign: "center", marginBottom: 0 },
  playerCardRow: { width: "100%", maxWidth: 236, flexDirection: "row", gap: 12, alignItems: "center", justifyContent: "center", marginTop: 30 },
