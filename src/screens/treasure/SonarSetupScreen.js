...
const styles = StyleSheet.create({
  ...
  playerCardRow: { width: "100%", maxWidth: 236, flexDirection: "row", gap: 10, alignItems: "center", justifyContent: "center", marginTop: 6 },
  playerCard: { width: 106, height: 112, borderRadius: 18, alignItems: "center", justifyContent: "center", shadowColor: C.cyan, shadowOpacity: 0.18, shadowRadius: 10, shadowOffset: { width: 0, height: 0 }, elevation: 3 },
  playerCardSelected: { shadowOpacity: 0.62, shadowRadius: 20, elevation: 7, transform: [{ scale: 1.012 }] },
  playerCardImage: { width: "92%", height: "92%", borderRadius: 18 },
