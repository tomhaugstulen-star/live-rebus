...
export default function ChallengeSelectScreen({ onSelectRebus, onSelectTreasure }) {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.title}>Live Georebus</Text>
        ...
        <TouchableOpacity style={[styles.card, styles.treasureCard]} onPress={onSelectTreasure}>
          ...
          <Text style={styles.cardText}>Utforsk kartet. Finn skatten i tåken.</Text>
